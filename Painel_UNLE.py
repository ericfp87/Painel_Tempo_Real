...
print(f"GRCA {valor_grca}% Leituras Realizadas")

print(f"GRDT {valor_grdt}% Leituras Realizadas")

print(f"GRTO {valor_grto}% Leituras Realizadas")

print(f"GRIP {valor_grip}% Leituras Realizadas")

print(f"GRAL {valor_gral}% Leituras Realizadas")
